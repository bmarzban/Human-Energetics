...
% function out = CardiomyocyteModelScript(input)
...
CRtot = 35.04e-3; % (M per liter cell)
TEP   = 29.78e-3; % (M per liter cell)

Ox_capacity = 0.772; % oxidative capacity relative to control rat
x_ATPase = (0.5/0.6810)*1.0e-3; % ATP hydrolysis rate: M / s / (liter cytosol)

%by assuming human vs rat hr at rest and excersice:
% x_ATPase = (0.681/0.6810)*1.0e-3; % ATP hydrolysis rate: M / s / (liter cytosol)
